...
const CATALOG: Book[] = [
  {
    ...
    subtitle: 'Limits, Derivatives, and Foundations',
    ...
    coverImage: '/covers/calculus-vol1.jpg',
    chapters: 6,
    available: true,
  },
  {
    ...
    subtitle: 'Integration and Techniques',
    description: 'The second volume covering integral calculus, techniques of integration, applications of integrals, and an introduction to differential equations.',
    coverImage: '/covers/calculus-vol2.jpg',
    chapters: 6,
    available: false,
  },
  {
    ...
    subtitle: 'Sequences, Series, and Multivariable',
    description: 'The concluding volume exploring infinite sequences and series, parametric equations, polar coordinates, and multivariable calculus.',
    coverImage: '/covers/calculus-vol3.jpg',
    chapters: 6,
    available: false,
  },
];
